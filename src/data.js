...
export const products = [
  ...
  },
  {
    ...
    variants: ["Bucket Bunga Soft Pink Estetik 1.jpg","Bucket Bunga Soft Pink Estetik 2.jpg"],
    bestSeller: false,
  ...
  },
  {
    ...
    price: 'Rp 25.000',
    image: 'Putih.jpg',
    variants: ["Putih.jpg","pink.jpg","ungu.jpg","merah.jpg"],
    bestSeller: false,
...
export const collaborations = [
  {
    id: 101,
    name: 'Baking Class: Scoopable Cookies 🍪',
    type: 'Cooking Baking Class',
    isComingSoon: true,
    partner: ["Your Cap","By Rentz","Benings Clinic","Fugo Hotel Banjarmasin"],
    date: '24 Mei 2026',
    location: 'FUGO Hotel Banjarmasin',
    ...
    gallery: ["https://images.unsplash.com/photo-1516627145497-ae6968895b74?auto=format&fit=crop&q=80&w=600","https://images.unsplash.com/photo-1490750967868-88aa4486c946?auto=format&fit=crop&q=80&w=600"]
  },
  {
    id: 102,
    name: 'Letters to the Heart: Journaling Class (Valentine Day)💖',
    type: 'Journaling Class',
    isComingSoon: false,
    partner: ["Your Cap","Menty","Emina Cosmetics","FamLaundryBjm","Fave Hotel Banjarmasin"],
    date: '15 Februari 2026',
    location: 'Fave Hotel Banjarmasin',
    ...
    gallery: ["kegiatan/journaling class work.jpg","kegiatan/journaling class work 2.jpg"]
  },
  {
    id: 103,
    name: 'Mochi Cheesecake Class 🍰🍡🧀',
    type: 'Cooking Baking Class',
    isComingSoon: false,
    partner: ["Your Cap","Glosa Skin","Seol-a Dessert House","Ketemu Studio","FUGO Hotel Banjarmasin"],
  ...
  {
    id: 104,
    name: 'Chunky Bag Class is back🙋🏻♀️',
    type: 'Decoration Class',
    isComingSoon: false,
    partner: ["Your Cap","The Last Love","Ashaya","Make Over","Bamega Laundry"],
    date: '30 November 2025',
    location: 'Last Love Cosmetics, Banjarbaru',
  ...
  {
    id: 105,
    name: 'Crochet Fairy Bow Class is here! 🎀',
    type: 'Decoration Class',
    isComingSoon: false,
    partner: ["Your Cap","Brownie Handcrafted","Wardah","FUGO Hotel Banjarmasin"],
    date: '5 Oktober 2025',
    location: 'FUGO Hotel Banjarmasin',
  ...
  {
    id: 106,
    name: '🍰 DESSERT BOX CLASS is here! “Layer by layer, make it yours.” 💖',
    type: 'Cooking Baking Class',
    isComingSoon: false,
    partner: ["Your Cap","Seol-a Dessert House","Wardah","Trend6forlife","Aeris Hotel Banjarbaru"],
    date: '14 September 2025',
    location: 'Calypso Meeting Room, Aeris Hotel BJB',
  ...
  {
    id: 107,
    name: 'Chunky Bag Class - Your Cap & Ketemu Studio',
    type: 'Decoration Class',
    isComingSoon: false,
    partner: ["Your Cap","Ketemu Studio","Seol-a Dessert House"],
    date: '3 Agustus 2025',
    location: 'Ketemu Studio Banjarmasin',
  ...
  {
    id: 108,
    name: 'Cake Picnic BY Your Cap',
    type: 'Event',
    isComingSoon: false,
    partner: ["Your Cap","Haka Koffie","Picnic Buddy","Kalsel Next","Joy Galleria"],
    date: '29 Juni 2025',
    location: 'Haka Koffie Banjarmasin',
